...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    if (CSToastDisplayShadow) {
        wrapperView.layer.shadowColor = MColor(71, 71, 71).CGColor;
        wrapperView.layer.shadowOpacity = CSToastShadowOpacity;
        wrapperView.layer.shadowRadius = CSToastShadowRadius;
        wrapperView.layer.shadowOffset = CSToastShadowOffset;
    }

    wrapperView.backgroundColor = [MColor(71, 71, 71) colorWithAlphaComponent:CSToastOpacity];
...
-(void)createReturnBtn {
    ...
    UIImage *buttonimage = [UIImage imageNamed:@"ico_back"];
    
    buttonimage = [buttonimage imageWithRenderingMode:(UIImageRenderingModeAlwaysOriginal)];//去掉UIButton的渲染色
    [barView.leftBtn setImage:buttonimage forState:(UIControlStateNormal)];
    [barView.leftBtn addTarget:self action:@selector(handleReturn) forControlEvents:(UIControlEventTouchUpInside)];
